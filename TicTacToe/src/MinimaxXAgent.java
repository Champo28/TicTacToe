...
/**
 * The MinimaxXAgent class uses the Minimax algorithm
 * to make optimal moves for the "X" player in a game. It is designed to play against opponents
...
public class MinimaxXAgent {
    ...
    /**
     * Plays a move using the Minimax algorithm for the 'X' player.
     *
    ...
    /**
     * The Minimax algorithm for determining the best move for the 'X' player.
     *
     * @param board                The current layout (board) of the game.
